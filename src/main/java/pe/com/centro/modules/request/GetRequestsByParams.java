...
@Slf4j
public class GetRequestsByParams implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    @Override
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        List<RequestControl> request = dao.findAllByParams(perns,bukrs);
